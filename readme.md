...
This is a CMake setup that loads SDL3 with SDL_GPU, stb_image, stb_truetype, and a custom 2d library made to work with it. It has an OpenGL backend for porting to web GPU or a SDL_GPU to port to any platform. It already has some scripts to build on web but you need to install the web libraries (mscripten) and vulkan to compile the shaders.


## ! Important

You need vulkan installed to compile the shaders. Also, this repo is more of an experiment and I don't really know yet how reliable it is. You can also try this version that only has OpenGL: https://github.com/meemknight/SDL3Setup
